/**
 * Backend-neutral frame-timing tracker.
 *
 * Both renderer backends report the same `ModelPreviewPerformanceSnapshot`
 * shape, so the timing math lives here rather than in either scene file.
 */

export interface PreviewSmoothnessSnapshot {
...
export class PreviewSmoothnessTracker {
  ...
  snapshot(): PreviewSmoothnessSnapshot {
