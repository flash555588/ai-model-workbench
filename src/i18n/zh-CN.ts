...
export const zhCN: Record<TranslationKey, string> = {
  ...
  "settings.language.desc": "选择 AI Model Workbench 在设置、预览控件、诊断信息和知识流程标签中的表达方式。切换会立即生效，并且只保存在当前仓库。",
  "settings.language.englishName": "English",
  "settings.language.chineseName": "简体中文",
  ...
  "settings.enableSldprt": "启用 FreeCAD 转换器（SolidWorks/Parasolid/CATIA）",
  "settings.enableSldprt.desc": "启用 SolidWorks（sldprt）、Parasolid（x_t、x_b）和 CATIA（catpart、catproduct）文件通过 FreeCAD 转换。需要安装 FreeCAD (https://www.freecad.org/downloads.php)。",
  ...
  "settings.freecadCmd": "FreeCAD 命令路径（CAD 转换用）",
  "settings.freecadCmd.desc": "可选的 FreeCAD 命令路径，用于 SolidWorks、Parasolid 和 CATIA 文件转换。Windows 通常用 FreeCADCmd.exe，macOS 通常用 FreeCADCmd，Linux 通常用 freecadcmd。设置后覆盖自动发现和 AI3D_FREECADCMD。",
  ...
  "settings.renderScale.desc": "画布分辨率倍数。1.0 = 原始，0.5 = 一半，2.0 = 双倍（超采样）。范围：0.25–2.0。",
  ...
  "helper.toggleSliceLabel": "切片模型",
  "helper.sliceButtonText": "切片",
  "helper.sliceOn": "切片已开启",
  "helper.sliceOff": "切片已关闭",
  "helper.sliceTitle": "切片",
  "helper.sliceOffsetLabel": "位置：",
  "helper.sliceNormalLabel": "法线：",
  "helper.sliceTiltLabel": "世界倾角：",
  "helper.sliceRotationLabel": "旋转：",
  "helper.sliceModeLabel": "控制：",
  "helper.sliceModeMove": "上下移动",
  "helper.sliceModeRotate": "旋转板子",
  "helper.sliceMoveReady": "拖动中心箭头移动，其他区域旋转视角",
  "helper.sliceRotateReady": "拖动彩色旋转环，其他区域旋转视角",
  "helper.sliceMoving": "正在移动切片板",
  "helper.sliceRotating": "正在旋转切片板",
  "helper.sliceGizmoReady": "拖动箭头或轴向圆环，其他区域旋转视角",
  "helper.interactionModeAnnotation": "标注模式",
  "helper.interactionModeFocus": "聚焦模式",
  "helper.interactionModeDisassembly": "拆解模式",
  "helper.interactionModeMeasurement": "测量模式",
  "helper.interactionModeSlice": "切片模式",
  "helper.sliceReady": "切面就绪",
  "helper.sliceDragging": "正在拖动切面",
  "helper.sliceAxisLabel": "截面：",
  "helper.sliceAxisValue": "{axis} 截面",
  "helper.slicePlaneX": "YZ",
  "helper.slicePlaneY": "XZ",
  "helper.slicePlaneZ": "XY",
  "helper.slicePositionLabel": "中心：",
  "helper.sliceThicknessLabel": "窗口：",
  "helper.slicePresetLabel": "预设：",
  "helper.slicePresetFine": "精细",
  "helper.slicePresetThin": "薄片",
  "helper.slicePresetWide": "宽窗",
  "helper.slicePresetFull": "全厚",
  "helper.sliceNudgeBack": "后移切片",
  "helper.sliceNudgeForward": "前移切片",
  "helper.sliceNarrower": "缩小切片窗口",
  "helper.sliceWider": "扩大切片窗口",
  "helper.sliceReset": "重置为世界水平中心",
  "helper.sliceSummary": "{axis} / {position} / {thickness}",
  "helper.changeResolutionLabel": "切换渲染缩放",
  "helper.resolutionValue": "渲染缩放：{value}",
  "helper.cameraZoomLabel": "相机缩放",
  "helper.cameraZoomValue": "缩放：{value}",
  "helper.toggleAnimationLabel": "播放或暂停动画",
  "helper.playing": "播放中",
  "helper.paused": "已暂停",
  "helper.toggleMeasurementLabel": "测量整个模型；先聚焦零件可限制范围；按 Alt/Option 自由取点",
  ...
  "helper.measurementSelectTarget": "选择目标",
  "helper.measurementPickStart": "选择起点",
  "helper.measurementPickEnd": "选择终点",
  "helper.measurementSnapVertex": "吸附：顶点",
  "helper.measurementSnapEdge": "吸附：边",
  "helper.measurementSnapFree": "自由取点",
  "helper.measurementTargetLabel": "目标：{target}",
  "helper.measurementTargetMissing": "点击对象",
  "helper.measurementTargetModel": "整个模型",
  "helper.measurementReviewing": "查看测量",
  "helper.measurementStripSaved": "{count} 条",
  "helper.measurementStripEmpty": "未记录",
  "helper.measurementStripMeta": "{count} 条 / {unit}",
  "helper.measurementRecordsTitle": "记录",
  "helper.measurementNoRecords": "暂无保存的测量",
  "helper.measurementCalibrationTitle": "参考缩放",
  "helper.measurementModelSizeTitle": "模型校准",
  "helper.measurementUnitLabel": "单位：",
  "helper.calibrateLabel": "模型缩放",
  "helper.calibrateTitle": "模型缩放",
  "helper.calibrateReference": "最新尺子：",
  "helper.calibrateReferenceEmpty": "请先测量一段距离",
  "helper.calibrateReferencePlaceholder": "真实长度",
  "helper.calibrateReferenceApply": "缩放模型",
  "helper.calibrateCurrent": "模型尺寸：",
  "helper.calibrateReal": "已知尺寸：",
  "helper.calibrateLock": "等比",
  "helper.calibrateApply": "应用",
  "helper.calibrateReset": "重置",
  "helper.calibrated": "模型缩放已应用",
  "helper.calibrateNeedsValue": "请输入正数目标尺寸",
  "helper.calibrateResetDone": "模型缩放已重置",
  "helper.calibrateOpen": "模型缩放已展开",
  "helper.calibrateClose": "模型缩放已收起",
  ...
  "directWorkbench.registeredConfirm": "确认",
  "directWorkbench.registeredReject": "非同一零件",
  "directWorkbench.registeredConfirmed": "已确认",
  "directWorkbench.registeredRejected": "非同一零件",
  "directWorkbench.registeredUndoReview": "撤销",
  "directWorkbench.registeredShowAll": "显示全部 {count} 项",
  ...
  "codeBlock.gridTitle": "网格",
  "codeBlock.interactHint": "拖动旋转 · 滚轮缩放 · 右键平移",
  "codeBlock.gridModelCount": "{count} 个模型",
