export const en = {
  ...
  "settings.language.desc": "Choose how AI Model Workbench writes its settings, preview controls, diagnostics, and knowledge-workflow labels. The switch is immediate and stays local to this vault.",
  "settings.language.englishName": "English",
  ...
  "settings.enableSldprt": "Enable FreeCAD conversion for SolidWorks/Parasolid/CATIA files",
  "settings.enableSldprt.desc": "Enable conversion for SolidWorks (sldprt), Parasolid (x_t, x_b), and CATIA (catpart, catproduct) files via FreeCAD. Requires FreeCAD installed locally.",
  ...
  "settings.freecadCmd": "Path to the FreeCAD command for CAD conversion",
  "settings.freecadCmd.desc": "Optional path to the FreeCAD command used for SolidWorks, Parasolid, and CATIA file conversion. Windows usually uses FreeCADCmd.exe, macOS usually uses FreeCADCmd, and Linux usually uses freecadcmd. Overrides auto-discovery when set.",
  ...
  "settings.diagnostics.cadPythonCheck": "Python CAD bridge (cadquery, trimesh, OCP STEP/glTF)",
  ...
  "settings.renderScale.desc": "Canvas resolution multiplier. 1.0 = native, 0.5 = half, 2.0 = double (supersampling). Range: 0.25–2.0.",
  ...
  "modelLoad.dracoUnsupported": "This model uses Draco mesh compression, which the Three.js renderer does not support yet. Switch the preview to the Babylon.js renderer or convert the file to an uncompressed GLB/GLTF.",
  ...
  "helper.toggleSliceLabel": "Slice model",
  "helper.sliceButtonText": "Slice",
  "helper.sliceOn": "Slice on",
  "helper.sliceOff": "Slice off",
  "helper.sliceTitle": "Slice",
  "helper.sliceOffsetLabel": "Position:",
  "helper.sliceNormalLabel": "Normal:",
  "helper.sliceTiltLabel": "World tilt:",
  "helper.sliceRotationLabel": "Rotation:",
  "helper.sliceModeLabel": "Control:",
  "helper.sliceModeMove": "Move up/down",
  "helper.sliceModeRotate": "Rotate board",
  "helper.sliceMoveReady": "Drag the center arrow; drag elsewhere to orbit",
  "helper.sliceRotateReady": "Drag a colored ring; drag elsewhere to orbit",
  "helper.sliceMoving": "Moving cutting board",
  "helper.sliceRotating": "Rotating cutting board",
  "helper.sliceGizmoReady": "Drag the arrow or an axis ring; drag elsewhere to orbit",
  "helper.interactionModeAnnotation": "Annotation mode",
  "helper.interactionModeFocus": "Focus mode",
  "helper.interactionModeDisassembly": "Disassembly mode",
  "helper.interactionModeMeasurement": "Measurement mode",
  "helper.interactionModeSlice": "Slice mode",
  "helper.sliceReady": "Plane ready",
  "helper.sliceDragging": "Dragging plane",
  "helper.sliceAxisLabel": "Plane:",
  "helper.sliceAxisValue": "{axis} section plane",
  "helper.slicePlaneX": "YZ",
  "helper.slicePlaneY": "XZ",
  "helper.slicePlaneZ": "XY",
  "helper.slicePositionLabel": "Center:",
  "helper.sliceThicknessLabel": "Window:",
  "helper.slicePresetLabel": "Preset:",
  "helper.slicePresetFine": "Fine",
  "helper.slicePresetThin": "Thin",
  "helper.slicePresetWide": "Wide",
  "helper.slicePresetFull": "Full",
  "helper.sliceNudgeBack": "Move slice backward",
  "helper.sliceNudgeForward": "Move slice forward",
  "helper.sliceNarrower": "Narrow slice window",
  "helper.sliceWider": "Widen slice window",
  "helper.sliceReset": "Reset to world-horizontal center",
  "helper.sliceSummary": "{axis} / {position} / {thickness}",
  "helper.changeResolutionLabel": "Change render scale",
  "helper.resolutionValue": "Render scale: {value}",
  ...
  "helper.toggleMeasurementLabel": "Measure model; focus a part first to limit scope; Alt/Option-click for free pick",
  ...
  "helper.measurementSelectTarget": "Select target",
  "helper.measurementPickStart": "Pick start",
  "helper.measurementPickEnd": "Pick end",
  "helper.measurementSnapVertex": "Snap: vertex",
  "helper.measurementSnapEdge": "Snap: edge",
  "helper.measurementSnapFree": "Free pick",
  "helper.measurementTargetLabel": "Target: {target}",
  "helper.measurementTargetMissing": "Click object",
  "helper.measurementTargetModel": "Entire model",
  "helper.measurementReviewing": "Reviewing",
  ...
  "helper.measurementRecordsTitle": "Records",
  "helper.measurementNoRecords": "No saved measurements",
  "helper.measurementCalibrationTitle": "Reference scale",
  "helper.measurementModelSizeTitle": "Model calibration",
  "helper.measurementUnitLabel": "Unit:",
  "helper.calibrateLabel": "Model scale",
  "helper.calibrateTitle": "Model scale",
  "helper.calibrateReference": "Latest ruler:",
  "helper.calibrateReferenceEmpty": "Measure a distance first",
  "helper.calibrateReferencePlaceholder": "Real length",
  "helper.calibrateReferenceApply": "Scale model",
  "helper.calibrateCurrent": "Model size:",
  "helper.calibrateReal": "Known size:",
  "helper.calibrateLock": "Uniform",
  "helper.calibrateApply": "Apply",
  "helper.calibrateReset": "Reset",
  "helper.calibrated": "Model scale applied",
  "helper.calibrateNeedsValue": "Enter a positive target size",
  "helper.calibrateResetDone": "Model scale reset",
  "helper.calibrateOpen": "Model scale opened",
  "helper.calibrateClose": "Model scale closed",
  ...
  "previewCanvas.inlineLabel": "3D model preview: {model}",
  "previewCanvas.gridLabel": "3D model grid preview",
  "previewCanvas.liveLabel": "Embedded 3D model preview: {model}",
  "previewCanvas.directLabel": "3D file preview: {model}",
  ...
  "directWorkbench.registeredConfirm": "Confirm",
  "directWorkbench.registeredReject": "Not same",
  "directWorkbench.registeredConfirmed": "Confirmed",
  "directWorkbench.registeredRejected": "Not same",
  "directWorkbench.registeredUndoReview": "Undo",
  "directWorkbench.registeredShowAll": "Show all {count}",
  ...
  "codeBlock.gridTitle": "Grid",
  "codeBlock.interactHint": "Drag to rotate · Scroll to zoom · Right-drag to pan",
  "codeBlock.gridModelCount": "{count} models",
